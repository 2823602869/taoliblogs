import{_ as s,c as n,a as e,o as t}from"./app-BDGVfunK.js";const i={};function r(l,a){return t(),n("div",null,a[0]||(a[0]=[e(`<p>有朋友说最近使用苏醒的主题，后台加载速度比较慢 ? 。</p><p>在这里说明下：最主要是两个因素造成的，一个是谷歌字体，一个是头像的问题。</p><p>其他朋友，自行添加到functions.php即可?。</p><p>谷歌字体</p><p>后台加载谷歌字体也没什么卵用，所以直接把他禁止掉即可。</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">add_filter( &#39;gettext_with_context&#39;, &#39;disable_open_sans&#39;, 888, 4 );</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,9)]))}const c=s(i,[["render",r],["__file","index.html.vue"]]),p=JSON.parse('{"path":"/docs/guide/wordpress/2020-06-23-wordpresshoutaijiazaisudumandewenti/","title":"WordPress后台加载速度慢的问题","lang":"en-US","frontmatter":{"title":"WordPress后台加载速度慢的问题","date":"2020-06-23","categories":["wp","blog"],"coverImage":"timthumb.jpg"},"headers":[],"git":{"createdTime":null,"updatedTime":null,"contributors":[]},"filePathRelative":"docs/guide/wordpress/2020-06-23-wordpress后台加载速度慢的问题/index.md"}');export{c as comp,p as data};
