import{_ as e,c as s,a,o as i}from"./app-CZypL58b.js";const l={};function t(d,n){return i(),s("div",null,n[0]||(n[0]=[a(`<p>同一个nginx上安装多个网站的方法</p><p>在nginx.conf的http{}中按照说明修改server{}字段</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">server {</span>
