import{_ as e,c as s,a,o as i}from"./app-CZypL58b.js";const l={};function t(d,n){return i(),s("div",null,n[0]||(n[0]=[a(`<h2 id="方法" tabindex="-1"><a class="header-anchor" href="#方法"><span>方法：</span></a></h2><p>在nginx.conf的http{}中按照说明修改server{}字段</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">server {</span>
...
<span class="line">}</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这样就可以禁止访问/admin/test目录下的任何文件</p>`,9)]))}const r=e(l,[["render",t],["__file","index.html.vue"]]),c=JSON.parse('{"path":"/blogs/post-doc/2020/06/2020-06-07-nginxtianjiaduogewangzhanjinzhiipfangwen/","title":"nginx添加多个网站禁止ip访问","lang":"en-US","frontmatter":{"title":"nginx添加多个网站禁止ip访问","date":"2020-06-07","categories":["html","blog"],"tags":["nginx"],"coverImage":"2020042612355625.jpg"},"headers":[{"level":2,"title":"方法：","slug":"方法","link":"#方法","children":[]},{"level":2,"title":"以下是禁止通过ip访问的代码","slug":"以下是禁止通过ip访问的代码","link":"#以下是禁止通过ip访问的代码","children":[]},{"level":2,"title":"禁止访问某些目录","slug":"禁止访问某些目录","link":"#禁止访问某些目录","children":[]}],"git":{"createdTime":null,"updatedTime":null,"contributors":[]},"filePathRelative":"blogs/post-doc/2020/06/2020-06-07-nginx添加多个网站禁止ip访问/index.md"}');export{r as comp,c as data};
