import{_ as s,c as n,a as i,o as a}from"./app-BDGVfunK.js";const l={};function t(d,e){return a(),n("div",null,e[0]||(e[0]=[i(`<p><strong>方法1：少量IP手动绑定:</strong></p><p>（这里以绑定IP到eth0为例，其它网卡的话修改相应的文件名即可）</p><p>1.复制ifcfg-eth0的网卡配置文件并改名为ifcfg-eth0:0</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">[root@taoli /]# cd /etc/sysconfig/network-scripts</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><p>再测试一下，能ping就大功告成了。</p>`,18)]))}const c=s(l,[["render",t],["__file","index.html.vue"]]),p=JSON.parse('{"path":"/docs/guide/Linux/2020-06-03-centosshezhiduogeipdizhi/","title":"centos设置多个ip地址","lang":"en-US","frontmatter":{"title":"centos设置多个ip地址","date":"2020-06-03","categories":["linux","blog"],"tags":["centos","linux"],"coverImage":"linux.png"},"headers":[],"git":{"createdTime":null,"updatedTime":null,"contributors":[]},"filePathRelative":"docs/guide/Linux/2020-06-03-centos设置多个ip地址/index.md"}');export{c as comp,p as data};
