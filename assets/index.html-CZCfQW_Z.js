import{_ as e,c as n,a,o as i}from"./app-Cw2o-BxM.js";const l={};function d(t,s){return i(),n("div",null,s[0]||(s[0]=[a(`<h2 id="linux关机-重启" tabindex="-1"><a class="header-anchor" href="#linux关机-重启"><span>Linux关机,重启</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line"># 关机shutdown -h now# 重启shutdown -r now</span>
