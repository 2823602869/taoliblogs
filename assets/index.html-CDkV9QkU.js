import{_ as s,c as n,a as i,o as a}from"./app-BDGVfunK.js";const l={};function t(r,e){return a(),n("div",null,e[0]||(e[0]=[i(`<p><strong>方法1：少量IP手动绑定:</strong></p><p>（这里以绑定IP到eth0为例，其它网卡的话修改相应的文件名即可）</p><p>1.复制ifcfg-eth0的网卡配置文件并改名为ifcfg-eth0:0</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">[root@taoli /]# cd /etc/sysconfig/network-scripts</span>
